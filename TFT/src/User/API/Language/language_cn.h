...
#define _LANGUAGE_CN_H_
    ...
    #define CN_RETRACT_SWAP_LENGTH    "Retract swap length"
    #define CN_RETRACT_Z_LIFT         "Z lift on retraction"
    #define CN_RECOVER_FEEDRATE       "Recover feedrate"
    #define CN_SWAP_RECOVER_FEEDRATE  "Swap recover feedrate"
    #define CN_RECOVER_LENGTH         "Extra recover length"
