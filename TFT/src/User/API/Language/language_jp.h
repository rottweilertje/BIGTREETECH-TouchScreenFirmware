...
#define _LANGUAGE_JP_H_
    ...
    #define JP_RESET_SETTINGS_INFO    "Reset all settings to\ndefault values?"
    #define JP_RESET_SETTINGS_DONE    "Reset all settings\nsuccessful.\nplease restart the device."
    #define JP_INFO                   "Info"
    ...
    #define JP_RETRACT_SWAP_LENGTH    "Retract swap length"
    #define JP_RETRACT_Z_LIFT         "Z lift on retraction"
    #define JP_RECOVER_FEEDRATE       "Recover feedrate"
